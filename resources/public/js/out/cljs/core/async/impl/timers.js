...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8442__auto__,writer__8443__auto__,opt__8444__auto__){return cljs.core._write.call(null,writer__8443__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_27890 = 0;while(true){
if((i_27890 < arr.length))
{(arr[i_27890] = null);
{
var G__27891 = (i_27890 + 1);
i_27890 = G__27891;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8442__auto__,writer__8443__auto__,opt__8444__auto__){return cljs.core._write.call(null,writer__8443__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_27897 = (self__.level + 1);while(true){
if((i_27897 <= (new_level + 1)))
{(update[i_27897] = self__.header);
{
var G__27898 = (i_27897 + 1);
i_27897 = G__27898;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_27899 = 0;while(true){
if((i_27899 <= self__.level))
{var links_27900 = (update[i_27899]).forward;if(((links_27900[i_27899]) === x__$1))
{(links_27900[i_27899] = (x__$1.forward[i_27899]));
{
var G__27901 = (i_27899 + 1);
i_27899 = G__27901;
continue;
}
} else
{{
var G__27902 = (i_27899 + 1);
i_27899 = G__27902;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7875__auto__ = (cljs.core.truth_((function (){var and__7863__auto__ = me;if(cljs.core.truth_(and__7863__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7863__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7875__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7875__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7875__auto__,timeout__$1,me))
,msecs);
