...
{{
var G__28102 = cljs.core.pop.call(null,v__$1);
v__$1 = G__28102;
continue;
}
} else
...
{var pred__28106 = cljs.core._EQ_;var expr__28107 = limit;if(cljs.core.truth_(pred__28106.call(null,1,expr__28107)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__28106.call(null,2,expr__28107)))
...
var G__28109 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__28110 = (limit__$1 - 1);
var G__28111 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__28109;
limit__$1 = G__28110;
parts = G__28111;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___28113 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___28113))
{var replacement_28114 = temp__4124__auto___28113;buffer.append([cljs.core.str(replacement_28114)].join(''));
} else
{buffer.append(ch);
}
{
