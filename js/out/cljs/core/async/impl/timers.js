...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17298 = 0;while(true){
if((i_17298 < arr.length))
{(arr[i_17298] = null);
{
var G__17299 = (i_17298 + 1);
i_17298 = G__17299;
continue;
}
} else
...
{var i_17305 = (self__.level + 1);while(true){
if((i_17305 <= (new_level + 1)))
{(update[i_17305] = self__.header);
{
var G__17306 = (i_17305 + 1);
i_17305 = G__17306;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17307 = 0;while(true){
if((i_17307 <= self__.level))
{var links_17308 = (update[i_17307]).forward;if(((links_17308[i_17307]) === x__$1))
{(links_17308[i_17307] = (x__$1.forward[i_17307]));
{
var G__17309 = (i_17307 + 1);
i_17307 = G__17309;
continue;
}
} else
{{
var G__17310 = (i_17307 + 1);
i_17307 = G__17310;
continue;
}
}
