...
{{
var G__17510 = cljs.core.pop.call(null,v__$1);
v__$1 = G__17510;
continue;
}
} else
...
{var pred__17514 = cljs.core._EQ_;var expr__17515 = limit;if(cljs.core.truth_(pred__17514.call(null,1,expr__17515)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__17514.call(null,2,expr__17515)))
...
var G__17517 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__17518 = (limit__$1 - 1);
var G__17519 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__17517;
limit__$1 = G__17518;
parts = G__17519;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___17521 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___17521))
{var replacement_17522 = temp__4124__auto___17521;buffer.append([cljs.core.str(replacement_17522)].join(''));
} else
{buffer.append(ch);
}
{
var G__17523 = (index + 1);
index = G__17523;
continue;
}
}
